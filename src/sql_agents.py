...
import gdown
id = "1Q7GnaGpXxmrI2S7mxKmeFFqj8dotsxAM"
output = "ds-salaries.csv"
...
response = chain.invoke(
    {
        "text": "Which company has better models OpenAI or Anthropic? Respond simply with just the company name only."
    }
)
